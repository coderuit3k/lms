...
export function SiteFooter() {
  return (
    <footer className="bg-surface-container-highest w-full mt-auto">
      <div className="w-full py-stack-md px-margin-mobile md:px-margin-desktop flex flex-col md:flex-row justify-between items-center max-w-container-max mx-auto gap-4">
        <div className="flex flex-col items-center md:items-start gap-1">
          <span className="font-display text-headline-md text-on-surface">Scholaris</span>
          <p className="font-label-sm text-label-sm text-on-surface-variant">
            © 2026 Scholaris Academy. Trao quyền tri thức toàn cầu.
          </p>
        </div>
